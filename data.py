...
def load_dataset(config, train_pos='sentiment.train.1', train_neg='sentiment.train.0',
                 dev_pos='sentiment.dev.1', dev_neg='sentiment.train.0',
                 test_pos='sentiment.test.1', test_neg='sentiment.test.0'):
...
if __name__ == '__main__':
    train_iter, _, _, vocab = load_dataset('amazon/')
    print(len(vocab))
